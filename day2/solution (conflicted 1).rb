...
def test_noun_and_verb(program_input, noun, verb)
  day2_input = program_input.clone
  day2_input[1] = noun
  day2_input[2] = verb
...
0.upto(99) do |noun|
  0.upto(99) do |verb|
    result = test_noun_and_verb(day2_input_original, noun, verb)
    if(result == expected_product_zero)
